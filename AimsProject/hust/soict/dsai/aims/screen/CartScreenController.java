...
public class CartScreenController {
    ...
    void btnPlayPressed(ActionEvent event) {
        ...
        String selectedMediaTitle = tblMedia.getSelectionModel().selectedItemProperty().get().getTitle();
        JDialog d = new JDialog(f, selectedMediaTitle + " is now being played...", true);
